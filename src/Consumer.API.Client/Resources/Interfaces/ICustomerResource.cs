...
public interface ICustomerResource
{
    ...
    Task<ErrorOr<PaginatedList<CustomerResponse>>> ByPageDetail(int? pageSize, int? pageIndex, bool? nextPage = null, 
        string? keyId = null, CancellationToken ct = default);
    Task<ErrorOr<IList<CustomerForListingResponse>>> All(CancellationToken ct = default);
    Task<ErrorOr<IList<CustomerResponse>>> AllDetail(CancellationToken ct = default);
