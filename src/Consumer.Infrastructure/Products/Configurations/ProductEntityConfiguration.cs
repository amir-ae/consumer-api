...
public class ProductEntityConfiguration : IEntityTypeConfiguration<Product>
{
    ...
    {
        builder.ToTable("products", ConsumerDbContext.DefaultSchema);
        ...
        builder.Property(p => p.ProductOrders)
            .HasColumnName(nameof(Product.ProductOrders).ToSnakeCase())
            .HasConversion(new ProductOrdersValueConverter())
            .IsRequired()
            .Metadata.SetValueComparer(new ProductOrdersValueComparer());
