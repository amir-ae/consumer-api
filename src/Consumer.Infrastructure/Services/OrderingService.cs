...
public class OrderingService : IOrderingService
{
    ...
    public async Task PublishOrderAsync(OrderForCreationMessage orderForCreationMessage, CancellationToken ct = default)
    {
        await _bus.Publish(orderForCreationMessage, ct);
    }
