...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Consumer.Domain.Common.Entities.CustomerOrder", b =>
                {
                    ...
                    b.ToTable("customer_order", "consumer");
                });

            modelBuilder.Entity("Consumer.Domain.Common.Entities.CustomerProduct", b =>
                {
                    b.Property<string>("CustomerId")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)")
                    ...
                    b.ToTable("customer_product", "consumer");
                });

            modelBuilder.Entity("Consumer.Domain.Common.Entities.ProductOrder", b =>
                {
                    b.Property<string>("ProductId")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                    ...
                    b.ToTable("product_order", "consumer");
                });

            modelBuilder.Entity("Consumer.Domain.Customers.Customer", b =>
                {
                    ...
                    b.Property<string>("CustomerOrders")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("customer_orders");
            ...
            modelBuilder.Entity("Consumer.Domain.Products.Product", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                    ...
                    b.ToTable("products", "consumer");
                });

            modelBuilder.Entity("Consumer.Domain.Common.Entities.CustomerOrder", b =>
                {
                    b.HasOne("Consumer.Domain.Customers.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Consumer.Domain.Common.Entities.CustomerProduct", b =>
                {
                    ...
                    b.HasOne("Consumer.Domain.Products.Product", "Product")
            ...
            modelBuilder.Entity("Consumer.Domain.Customers.Customer", b =>
                {
                    b.OwnsOne("Consumer.Domain.Customers.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
