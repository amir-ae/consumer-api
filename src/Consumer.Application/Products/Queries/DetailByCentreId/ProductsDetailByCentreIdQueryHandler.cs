...
public sealed class ProductsDetailByCentreIdQueryHandler : IRequestHandler<ProductsDetailByCentreIdQuery, ErrorOr<ProductResponse[]>>
{
    ...
    public async Task<ErrorOr<ProductResponse[]>> Handle(ProductsDetailByCentreIdQuery query, CancellationToken ct = default)
    {
