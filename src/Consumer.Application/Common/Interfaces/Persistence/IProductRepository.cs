...
public interface IProductRepository
{
    ...
    Task<(List<Product>, long)> ByPageAsync(int pageSize, int pageIndex, bool? nextPage, ProductId? keyId, 
        CentreId? centreId, CancellationToken ct = default);
    Task<(List<Product>, long)> ByPageDetailAsync(int pageSize, int pageIndex, bool? nextPage, ProductId? keyId, 
        CentreId? centreId, CancellationToken ct = default);
    ...
    void Append(ProductEvent productEvent, int? version = null);
