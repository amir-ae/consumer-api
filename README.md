...
Welcome to the Consumer API repository! This project provides an API to manage customer data, including functionalities to paginate through customer lists. It is built using .NET Minimal APIs and follows best practices for performance and scalability.
...
1. Clone the repository:
    ```bash
    git clone https://github.com/amir-ae/consumer-api.git
    cd consumer-api
    ```
...
The Consumer API provides several endpoints to manage customer data. Below are the details of example endpoints:
...
**Request Body:**
- `createBy` (string, required): The ID of the user making the request.
...
**Request Body:**
- `updateBy` (string, required): The ID of the user making the request.
