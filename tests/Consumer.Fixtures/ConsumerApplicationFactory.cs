...
namespace Consumer.Fixtures
{
    public class ConsumerApplicationFactory<Program> : WebApplicationFactory<Program> where Program : class
    {
        private readonly string _connectionString =
            "server=localhost; port=5432; timeout=15; pooling=True; minpoolsize=1; maxpoolsize=100; commandtimeout= 20; database=ConsumerTests; user id=postgres; password=T1VWLjZIofw60dVeYI2s; integratedsecurity=True";
